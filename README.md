...
[![Flow-next](https://img.shields.io/badge/Flow--next-v0.3.3-green)](plugins/flow-next/)
...
> 🤖 **New in v0.3.3**: [Ralph mode](#ralph-autonomous-mode) — autonomous overnight coding with multi-model review gates.
